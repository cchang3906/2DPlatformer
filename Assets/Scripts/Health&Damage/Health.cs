...
public class Health : MonoBehaviour
{
    ...
    void Respawn()
    {
        ...
        Debug.Log("Respawn#1" + isInvincible + currentHealth);
    }
    ...
    {
        Debug.Log("TakeDamage #1" + isInvincible + currentHealth);
        ...
        GameManager.UpdateUIElements();
        Debug.Log("TakeDamage #3" + isInvincible + currentHealth);
    }
    ...
    void Die()
    {
        ...
        if (useLives)
        {
            Debug.Log("Die #1:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance);
            currentLives -= 1;
            if (currentLives > 0)
            {
                Debug.Log("Die #2:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance);
                ...
                Debug.Log("Die #3:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance);
            }
            else
            {
                Debug.Log("Die #4:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance + ", respawnWaitTime" + respawnWaitTime);
                if (respawnWaitTime != 0)
                {
                    respawnTime = Time.time + respawnWaitTime;
                }
                ...
                Debug.Log("Die #5:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance);

                GameOver();
                Debug.Log("Die #6:" + isInvincible + ", health" + currentHealth + ", lives" + currentLives + ", gamemanager" + GameManager.instance);
            }
